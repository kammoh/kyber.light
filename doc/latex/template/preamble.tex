...
headinclude=on,
  footinclude=on,12pt,       %% twoside: document is printed on left and right sides
pagesize=pdftex
pagesize=pdftex]{scrreprt}  %% article class of KOMA: "scrartcl", "scrreprt", or "scrbook".
...
%     % pdfhighlight={DispositionColor!20}
% }
%doc%
...
%doc%
\usepackage[automark]{scrlayer-scrpage} %%  advanced page style using KOMA
...
style=ieee, %% see biblatex documentation%style=alphabetic, %% see biblatex documentationdashed=\mybiblatexdashed, %% do *not* replace recurring reference authors with a dash
backref=\mybiblatexbackref, %% create backlings from references to citations
natbib=true, %% offering natbib-compatible commands
hyperref=true, %% using hyperref-package references
]{biblatex}  %% remove, if using BibTeX instead of biblatex

\addbibresource[datatype=bibtex]{\mybiblatexfile} %% remove, if using BibTeX instead of biblatex
...
\renewcommand*\dictumauthorformat[1]{\hfill --- #1}
