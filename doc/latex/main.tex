...
\newcommand{\mybiblatexfile}{lattice.bib}
%% Name of the biblatex file that holds the references.

% \newcommand{\mydispositioncolor}{30,103,182}
\newcommand{\mydispositioncolor}{57,125,161}
...
%% general metadata:
\newcommand{\myauthor}{Kamyar Mohajerani}  %% also used for PDF metadata (hyperref)
\newcommand{\myauthorwithexistingtitles}{\myauthor{}, OLDDEGREE}  %% including
                                %% university degree already held
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{FPGA Implementation of Kyber.PKE}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubtitle}{Post-quantum Cryptography Public-key Encryption}  %% only used with title_Thesis_TU_Graz_-_kazemakase
\newcommand{\mysubject}{Post-Quantum Cryptography Public-key Encryption}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{PQC, Post-Quantum Cryptography, Lattice Cryptography, FPGA, Hardware}  %% also used for PDF metadata (hyperref)
...
\newcommand{\myuniversity}{George Mason University} %% your university/school
...
% \input{page_one}                %% this is a suggestion: you have to create this file on demand
